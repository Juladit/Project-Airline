...
//Concrete class representing Domestic Flight
public class DomesticFlight extends FlightDetails {
 public DomesticFlight(String flightNumber, String departure, String destination, int capacity, double pricePerSeat) {
 ...
 protected String generateTicket(int seatNumber, String firstName, String lastName) {
     ...
     ticket.append("\n-----------------------\n");
     ticket.append("Domestic Flight Ticket Details:\n");
